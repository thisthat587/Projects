...
class Con {
        ...
        #write() {
			...
			`;
                ...
                if (tempflag == 1) {
                        destination[0] = `<tr>
			<th>Destination</th>
			<td><input class="form-control" value="${this.#tbl_loc[0].destination}" readonly></input></td>
			</tr>`;
                        flag_dest = "YES"
                } else flag_dest = "NO";
                let alldisp = `
				<div class="d-grid">
					<button style="text-align: left;" class="btn btn-primary btn-block fixed-top" onclick="myApp.showDashboard('${this.#tbl_detail[0].admno}')"><i
                ...
                alldisp += `<tr>
		<th>Admission No</th>
		<td><input class="form-control" value="${this.#tbl_detail[0].admno}" readonly></input></td>
		
		</tr>
		<tr>
		<th>Name</th>
		<td><input class="form-control" value="${this.#tbl_detail[0].name}" readonly></input></td>
		
		</tr>
		<tr>
		<th>Class</th>
		<td><input class="form-control" value="${this.#tbl_detail[0].class}" readonly></input></td>
		
		</tr>
		<tr>
		<th>Section</th>
		<td><input class="form-control" value="${this.#tbl_detail[0].section}" readonly></input></td>
		
		</tr>
		<tr>
		<th>Roll</th>
		<td><input class="form-control" value="${this.#tbl_detail[0].roll}" readonly></input></td>
		
		</tr>
		<tr>
		<th>Father's Name</th>
		<td><input class="form-control" value="${this.#tbl_detail[0].fname}" readonly></input></td>
		
		</tr>
		<tr>
		<th>Mob No</th>
		<td><input class="form-control" value="${this.#tbl_detail[0].fmob}" readonly></input></td>
		
		</tr>
		<tr>
		<th>Whatsapp No</th>
		<td><input class="form-control" value="${this.#tbl_detail[0].whatsapp}" readonly></input></td>
		
		</tr>
		<tr>
		<th>Transport</th>					
		<td><input class="form-control" value="${flag_dest}" readonly></input></td>
		...
		<tr>
		<th>Monthly Fee</th>
		<td><input class="form-control" value="₹${this.#tbl_stdfeemaster[0].monthfee}.00" readonly></input></td>
		
		</tr>
		<tr>
		<th>Dues</th>
		<td><input class="form-control" value="₹${this.#tbl_monthfee[0].billdues}.00" readonly></input></td>
		
		</tr>
		<tr>
		<th>Monthly Fine</th>
		<td><input class="form-control" value="₹${this.#total_fine}.00" readonly></input></td>
		
		</tr>
		<tr>
		<th>Transport Fine</th>
		<td><input class="form-control" value="₹${this.#total_transfine}.00" readonly></input></td>
		
		</tr>
		
		<tr>
		<th>Session</th>
		<td><input class="form-control" value="${this.#tbl_detail[0].session}" readonly></input></td>
		...
		`;
                ...
                if (this.#tbl_detail[0].transport == "YES")
                        alldisp += `<tr>
	<th>Transport Fee</th>
	<td><input class="form-control" value="₹${this.#tbl_stdfeemaster[0].transportfee}.00" readonly></input></td>
	
	</tr>`;
                if (this.#tbl_detail[0].hostel == "YES")
                        alldisp += `<tr>
<th>Hostel Fee</th>
<td><input class="form-control" value="₹${this.#tbl_stdfeemaster[0].hostelfee}.00" readonly></input></td>
